...
const BODY_TEXT =
  'Over the last six years, I have partnered with clients across the UAE, UK, US, Australia, and Europe — applying deep UX/UI craft and conversion rate optimization to product interfaces and websites in Figma for SaaS, Fintech, E-commerce, Education, Trading, and Hospitality brands.'
      ...
      <div className="bg-[#101010] rounded-2xl md:rounded-[2rem] max-w-6xl mx-auto px-6 sm:px-10 md:px-16 py-20 md:py-28 text-center">
        ...
        <WordsPullUpMultiStyle
          ...
          segments={[
            ...
            {
              text: 'a senior UX/UI designer.',
              className: 'italic font-serif font-normal',
            },
            {
              text: 'Fluent in user research, design systems, prototyping, and conversion rate optimization — UX and UI as one craft.',
